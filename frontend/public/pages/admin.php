...
<main>
    ...
    <?php if (isset($_GET['msg'])): ?><div class="message-success"><?= htmlspecialchars($_GET['msg']) ?></div><?php endif; ?>
    <?php if (isset($error)): ?><div class="message-error"><?= htmlspecialchars($error) ?></div><?php endif; ?>
